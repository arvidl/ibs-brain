...
# Print start message
echo "Starting to copy longitudinal aseg.stats files..."
echo "From: $BASE_DIR"
echo "To: $TARGET_DIR"
echo "----------------------------------------"
...
while IFS= read -r file; do
    ...
    # Example path: /home/ben/BrainGut/BrainGut_fsLongAll/BG_004/BG_004_cross/BG_004_20190531_0825/stats/aseg.stats
    timepoint_dir=$(basename "$(dirname "$(dirname "$file")")")
    
    # Construct new filename
    new_filename="${timepoint_dir}_long_aseg.stats"
...
done < <(find "$BASE_DIR" -type f -path "*/BG_*/BG_*_cross/BG_*_*/stats/aseg.stats")
